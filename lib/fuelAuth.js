...
fuelAuth.prototype._verifyClient = function(options) {
	var message = null;
	if ((!options.clientId || !verifyAPIKey('clientId', options.clientId)) && (!options.clientSecret || !verifyAPIKey('clientSecret', options.clientSecret))) {
		message = 'clientId and clientSecret are missing or invalid';
	} else if (!options.clientId || !verifyAPIKey('clientId', options.clientId)) {
		message = 'clientId is missing or invalid';
	} else if (!options.clientSecret || !verifyAPIKey('clientSecret', options.clientSecret)) {
...
function verifyAPIKey(APIKeyType, key) {
	var check = false;
