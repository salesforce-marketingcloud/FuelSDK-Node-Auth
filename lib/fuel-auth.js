...
module.exports = class FuelAuth {
	constructor(options) {
		...
		this.authUrl = options.authUrl || (options.version === 2 ? `https://${options.tenant}.auth.marketingcloudapis.com/v2/token` : 'https://auth.exacttargetapis.com/v1/requestToken');
