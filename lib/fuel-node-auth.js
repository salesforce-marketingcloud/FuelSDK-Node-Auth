...
FuelNodeAuth.prototype.getAccessToken = function( requestOptions, forceRequest, callback ) {
	...
	if( this.isExpired() || Boolean( forceRequest ) ) {
		...
		this._deliverResponse( 'success', { accessToken: this.accessToken, expiresIn: this.expiration - process.hrtime()[0] }, callback );
	}
};
...
FuelNodeAuth.prototype._requestToken = function( requestOptions, callback ) {
	...
	request( options, function ( err, res, body ) {
		...
		this._deliverResponse( 'success', body, callback );
